...
### AutoML
**Definition:** Automated machine learning service that automates model selection, hyperparameter tuning, and deployment
...
**Definition:** Performance metric measuring the area under the ROC curve
...
### BigQuery ML
**Definition:** Create and execute ML models using SQL directly in BigQuery
...
**Definition:** User-controlled encryption keys for data security
...
**Definition:** Automated retraining of models based on triggers or schedules
...
**Definition:** Graph structure representing ML pipeline dependencies

**Use Case:** Workflow orchestration in Vertex AI Pipelines, Kubeflow


### Dataflow
**Definition:** Managed service for stream and batch data processing based on Apache Beam
...
**Definition:** Neural network with multiple hidden layers
...
### Feature Store
**Definition:** Centralized repository for storing, serving, and managing ML features
...
**Definition:** Access control service for GCP resources
...
**Definition:** ML workflow framework used in Vertex AI Pipelines
...
**Definition:** Service for creating and managing cryptographic keys
...
**Definition:** AWS managed Apache Airflow service
...
### Pub/Sub
**Definition:** Messaging service for event ingestion and distribution
...
**Definition:** Method for explaining individual predictions

**Use Case:** Model interpretability, feature importance


### SMOTE (Synthetic Minority Over-sampling Technique)
**Definition:** Technique for handling imbalanced datasets by generating synthetic examples
...
### Tabular Workflows
**Definition:** Enhanced AutoML with granular pipeline control
...
**Definition:** Library for preprocessing data in TensorFlow
...
**Definition:** Library for exploring and validating ML data

**Capabilities:** Schema inference, anomaly detection, drift detection


### TFX (TensorFlow Extended)
**Definition:** End-to-end platform for deploying production ML pipelines

**Components:** Data validation, transform, training, serving


### TPU (Tensor Processing Unit)
**Definition:** Google's custom chip optimized for ML workloads (GCP exclusive)
...
### Vertex AI
**Definition:** Unified ML platform consolidating training, deployment, and monitoring
...
**Definition:** Isolated network environment for GCP resources
...
**Definition:** Security perimeter for GCP resources to prevent data exfiltration
